...
def evaluate(model, img_x, att_x, q, k, v, key_padding_mask):
    ...
    # transformer
    macs2, params2 = profile(model.transformer, inputs=(q, k, v, key_padding_mask),
                             custom_ops=None, verbose=False)
    macs, params = clever_format([macs2, params2], "%.3f")
    macs_tran=macs2
    params_trans=params2
    print('transformer macs is ', macs)
    print('transformer params is ', params)
    ...
    print('head macs is ', macs2-macs_tran)
    print('head params is ', params2-params_trans)
